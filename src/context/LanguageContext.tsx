...
const translations = {
  en: {
    ...
    project_1_title: "Web Portfolio",
    project_1_type: "Frontend / UI",
    project_1_subtitle: "TECHNOLOGY STACK",
    project_1_desc: "HTML5\nCSS3\nJavaScript\nAOS Animation\nParticles.js\nFont Awesome",
  ...
  id: {
    ...
    project_1_title: "Web Portfolio",
    project_1_type: "Frontend / UI",
    project_1_subtitle: "TEKNOLOGI YANG DIGUNAKAN",
    project_1_desc: "HTML5\nCSS3\nJavaScript\nAOS Animation\nParticles.js\nFont Awesome",
