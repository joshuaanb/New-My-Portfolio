    ...
    <nav className="fixed top-0 left-0 w-full z-1000 flex justify-between items-center p-6 md:p-12 pointer-events-auto">
      ...
      >
        ...
        <div className="absolute bottom-12 flex gap-8">
          <a href="https://www.linkedin.com/in/josua-nababan-b186321b8/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-opacity p-2 border border-white/10 rounded-full flex items-center justify-center" title={t('linkedin')}>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
          </a>
          <a href="https://www.instagram.com/joshuaanb" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-opacity p-2 border border-white/10 rounded-full flex items-center justify-center" title={t('instagram')}>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
          </a>
          <a href="https://github.com/joshuaanb" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-opacity p-2 border border-white/10 rounded-full flex items-center justify-center" title={t('github')}>
